...
const PERFORMED: ReadonlyArray<[string, RegExp]> = [
  ...
  ['dictates for a learner with no screen', /Si va caminando o no tiene pantalla a mano/],
  ['closes those numbers in the next class', /cierran los números la clase siguiente/],
