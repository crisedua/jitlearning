...
Lo que no vale es enumerar las dos y dejarle a la persona el trabajo de elegir. Para eso no hacía falta preguntarte.`,
    firstMessage: '¿Qué estás intentando resolver con IA en tu empresa?',
    outOfScopeNote:
...
Lo que no vale es enumerar las dos y dejarle a la persona el trabajo de elegir. Para eso no hacía falta preguntarte.`,
    firstMessage: '¿Qué está pasando con la IA en tu colegio ahora mismo?',
    outOfScopeNote:
...
Lo que no vale es enumerar las dos y dejarle a la persona el trabajo de elegir. Para eso no hacía falta preguntarte.`,
    firstMessage: '¿En qué punto está tu negocio y dónde te has atascado?',
    outOfScopeNote:
